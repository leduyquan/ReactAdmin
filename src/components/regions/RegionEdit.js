...
const removeImage = (recordId, url) => {
  ...
  fetch(`${AppConstant.API_URL}/regions-admin/${recordId}/delete`, {
    method: "POST",
    headers: {
...
class RegionEdit extends Component {
  ...
  render() {
    ...
    return (
      <Edit title={<RegionTitle type="Edit" />} {...props}>
        <TabbedForm redirect="edit">
          <FormTab label="SUMMARY">
            ...
            />
            <ReferenceInput label="Place" validate={required()} style={styles.inputInline} source="parentID" reference="places-admin">
